...
/// How long the editor must be quiet before an auto-save fires. 1s is
/// deliberate: it matches Obsidian's local-save cadence, which is the feel
/// this editor is measured against. Shared between journal and generic notes
/// so the cadence stays consistent.
